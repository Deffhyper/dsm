                    ...
                    <div class="lk-order-item">
                        <div class="lk-order-item__header">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-sm-4 col-xs-12"><p class="lk-order-title text-bold">Заказ №25 </p>
                                    </div>
                                    <div class="col-sm-4 col-xs-12"><span>Дата заказа: <time>25.05.2017</time></span>
                                    </div>
                            ...
                            <div class="col-sm-6 col-xs-12 lk-order-item__content--left">
                                ...
                                <ul class="lk-order-item__content--list">
                                    ...
                                    <li>
                                        ...
                                        <a href="tel:+38 (035) 345-56-89" class="text-bold lk-order-item__tel">+38 (035)
                                            345-56-89</a>
                                    </li>
                                    <li>
                                        <span>E-mail: </span>
                                        <a href="mailto:boiko@example.com"
                                           class="link link-underline link--accent-hover">boiko@example.com</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-sm-12 lk-order-item__content--bottom">
                                ...
                                <table class="order-table__item">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" class="text-bold link__accent--hover">Epson Stylus Photo P50
                                                (C11CA45341) + USB cable </a></td>
                                        <td>1 шт.</td>
                                        <td>
                                            <p class="old-price">121 789 грн</p>

                                            <p class="current-price text-bold text-accent"><a href="#">120 438 грн</a>
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><img src="img/jpeg_files/cart-item-2.jpg" alt="photo"></td>
                                        <td><a href="#" class="text-bold link__accent--hover">Canon i-SENSYS LBP6230DW
                                                with Wi-Fi (9143B003)</a></td>
                                        <td>1 шт.</td>
                                        <td>
