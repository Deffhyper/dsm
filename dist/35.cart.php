                            ...
                            <tr class="lk-cart-table__body--item">
                                <td>
                                    <table>
                                        <tbody>
                                        <tr>
                                            <td class="img"><img src="img/jpeg_files/cart-item-big-1.jpg" alt="image">
                                            </td>
                                            <td class="text">
                                                <ul>
                                                    <li><a href="#" class="text-bold link__accent--hover">Epson Stylus
                                                            Photo P50 (C11CA45341) + USB cable</a></li>
                                                    <li>Цена:</li>
                                                    <li>
                                                        <span class="old-price">121 789 грн</span>
                                                        <a href="#" class="current-price text-accent text-bold">120 438
                                                            грн</a>
                                                    </li>
                                                    <li><span class="discount">Скидка: <span class="text-bold">5%</span></span>
                                                    </li>
                                                </ul>
                                            </td>
                                        </tr>
                                ...
                                <td>
                                    <ul class="cart-total-item">
                                        <li><span class="mob text-bold">Сумма: </span><a href="#"
                                                                                         class="text-bold text-accent">120
                                                438 грн</a></li>
                                        <li><a href="#" class="btn btn-link btn-with-accent-border">Отложить товар</a>
                                        </li>
                                    </ul>
                                </td>
                            ...
                            <tr class="lk-cart-table__body--item">
                                <td>
                                    <table>
                                        <tbody>
                                        <tr>
                                            <td class="img"><img src="img/jpeg_files/cart-item-big-2.jpg" alt="image">
                                            </td>
                                            <td class="text">
                                                <ul>
                                                    <li><a href="#" class="text-bold link__accent--hover">Epson Stylus
                            ...
                            <tr class="lk-cart-table__body--item">
                                <td>
                                    <table>
                                        <tbody>
                                        <tr>
                                            <td class="img"><img src="img/jpeg_files/cart-item-big-3.jpg" alt="image">
                                            </td>
                                            <td class="text">
                                                <ul>
                                                    <li><a href="#" class="text-bold link__accent--hover">Epson Stylus
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-5 col-xs-12">
                                        <div class="order-table__total">
                                            ...
                                            <a href="#" class="btn btn-link btn-round btn--blue pull-right">Оформить заказ</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
