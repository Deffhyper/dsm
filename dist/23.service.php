...
<div class="container">
    <div class="row">
        <h1 class="page-title">Сервис и поддержка</h1>
    </div>
</div>
            ...
            <ul class="template-orders__list">
                <li>
                    <a href="#">
                        ...
                        <span class=text-bold>Ремонт и обслуживание принтеров</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="img"><img src="img/jpeg_files/step-one-2.jpg" alt="image"></span>
                        <span class=text-bold>Ремонт и обслуживание многофункциональных устройств (МФУ)</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="img"><img src="img/jpeg_files/step-one-3.jpg" alt="image"></span>
                        <span class=text-bold>Ремонт и обслуживание широкоформатных принтеров (плоттеров)</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="img"><img src="img/jpeg_files/step-one-34.jpg" alt="image"></span>
                        <span class=text-bold>Ремонт и обслуживание копировальных аппаратов (КМА)</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span class="img"><img src="img/jpeg_files/step-one-35.jpg" alt="image"></span>
                        <span class=text-bold>Ремонт и обслуживание сканеров</span>
                    </a>
                </li>
                <li>
                    <a href="#">
